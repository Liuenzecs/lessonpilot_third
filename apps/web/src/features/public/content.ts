...
export const landingFeatures = [
  ...
  },
  {
    ...
    index: '③',
    title: '在线编辑，随时调整',
    description: '不满意？选中任意段落，一键重写。',
    bullets: ['像文档一样直接编辑', '局部润色与扩写', '历史版本可恢复'],
  },
  {
    id: 'export',
    index: '④',
...
export const helpGroups = [
  {
    ...
    items: [
      ...
      {
        question: '如何编辑生成的内容？',
        answer: '生成内容会以内联待确认卡片出现，你可以接受、拒绝或重新生成后再进入正式文档。',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '如何重新生成某个段落？',
        answer: '在编辑器里悬停段落后点击”重写”，或在段落中选中文本使用”润色 / 扩写”。',
      },
      {
        question: '生成的内容会有错误吗？',
        answer: '会有概率出现事实或表达偏差，所以系统默认把生成内容标记为待确认状态。',
      },
      {
...
export const privacySections = [
  ...
  },
  {
    ...
    title: '第三方服务说明',
    paragraphs: [
      '当你触发生成功能时，教案相关上下文会发送给配置中的第三方服务用于即时生成，不会被我们用于训练模型。',
...
export const termsSections = [
  ...
  },
  {
    ...
    title: '内容免责声明',
    paragraphs: [
      '生成内容仅供参考，教师需自行审核其准确性、适用性和最终教学效果。',
      'LessonPilot 不替代教师的专业判断，也不对未审核的生成内容承担教学适配责任。',
    ],
  },
  {
    id: 'copyright',
...
export const changelogEntries = [
  ...
  },
  {
    date: '2026-04-11',
    title: 'Phase 1 主链路完成',
    items: ['完成注册、创建任务、自动生成、编辑、导出 Word 的端到端闭环。'],
  },
];
